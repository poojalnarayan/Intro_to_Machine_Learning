...
\begin{center}
    ...
    \boldred{Due: Friday, September 1, 5pm} \\
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=12cm]{figures/Figure_1}
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=12cm]{figures/Figure_1_gray}
\caption{Gray image plotted from original humu file}
\label{fig2}
\end{center}
\end{figure}

Figure~\ref{fig2} The data from humu-2 file is used to plot this figure in gray scale.

%%%%%%%%%%%%% 3
\begin{figure}[htb]
\begin{center}
\includegraphics[width=12cm]{figures/Figure_1_random_grayscale}
\caption{Creating a grayscale image with uniformly random values}
\label{fig3}
\end{center}
\end{figure}

Figure~\ref{fig3} Creating a grayscale image with uniformly random values, if you generate more images they look different!

%%%%%%%%%%%%% 4
\begin{figure}[htb]
\begin{center}
\includegraphics[width=12cm]{figures/Figure_1_random_reloaded}
\caption{Creating a grayscale image from values of random file}
\label{fig4}
\end{center}
\end{figure}

Figure~\ref{fig4} Creating a grayscale image from values of random numpy taken from a file written in the previous step.
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=12cm]{figures/line_plot}
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=12cm]{figures/Figure_1_exercise11}
