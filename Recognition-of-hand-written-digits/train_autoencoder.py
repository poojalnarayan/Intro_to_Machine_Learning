...
hidden_size = 10  #changing here for diff size

# desired average activation of the hidden units.
# (This was denoted by the Greek alphabet rho, which looks like a lower-case "p",
#  in the lecture notes).
beta_ = 0.2   #change as required with different hidden_size
rho_ = 0.05
...
images = load_MNIST.load_MNIST_images('/home/pooja/Documents/INFO_521/HW-5/ista421ML-f2017-hw5-release/data/mnist/train-images-idx3-ubyte')
...
if RUN_STEP_1:
    ### YOUR CODE HERE ###
    visualize.plot_images(patches_train[:, 0:10],filepath= "/home/pooja/Documents/INFO_521/HW-5/ista421ML-f2017-hw5-release/Figures/load_10_images")
    visualize.plot_images(patches_train[:, 0:50],filepath= "/home/pooja/Documents/INFO_521/HW-5/ista421ML-f2017-hw5-release/Figures/load_50_images")
    visualize.plot_images(patches_train[:, 0:100],filepath= "/home/pooja/Documents/INFO_521/HW-5/ista421ML-f2017-hw5-release/Figures/load_100_images")
    visualize.plot_images(patches_test[:, 0:100],filepath= "/home/pooja/Documents/INFO_521/HW-5/ista421ML-f2017-hw5-release/Figures/load_100_test_images")
    pass
...
if RUN_STEP_5_TRAIN_AUTOENCODER:
    ...
    # define the objective function that returns cost and grad, used by scipy.optimize.minimize
    #J = lambda x: utils.autoencoder_cost_and_grad(x, visible_size, hidden_size, lambda_, patches_train)
    ...
    results_filepath_root = 'sparse_autoencoder_k{0}_h{1}_l{2}_ro{3}_beta{4}'.format(patches_train.shape[1],hidden_size, lambda_, rho_, beta_)
