...
\begin{flushright}
Pooja lakshmi Narayan %% Fill in your name here
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=6cm]{figures/Figure_1_prob2.png}
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=6cm]{figures/Figure_1_prob3.png}
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=6cm]{figures/Figure_1_prob4_LOOCV.png}
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=6cm]{figures/Figure_1_prob4_1.png}
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=6cm]{figures/Figure_1_prob4_1_1.png}
...
\begin{eqnarray*}
{(\mathbf{t} - \mathbf{X}\mathbf{w})}^\top  (\mathbf{t} - \mathbf{X}\mathbf{w})=  {(t_1 - (w_0 + w_1 x_1))}^2 + {(t_2 - (w_0 + w_1 x_2))}^2+....+{(t_N - (w_0 + w_1 x_N))}^2
\end{eqnarray*}

Thus the total loss:
\begin{eqnarray*}
\mathcal{L} = {(\mathbf{t} - \mathbf{X}\mathbf{w})}^\top  (\mathbf{t} - \mathbf{X}\mathbf{w})=  \sum_{n=1}^N \left( t_n - \mathbf{w}^\top \mathbf{x}_n \right)^2
\end{eqnarray*}
...
\mathcal{L} = {(\mathbf{t} - \mathbf{X}\mathbf{w})}^\top  (\mathbf{t} - \mathbf{X}\mathbf{w})\\
    = \mathbf{t}^\top \mathbf{t} - \mathbf{t}^\top \mathbf{X}\mathbf{w} - {(\mathbf{X}\mathbf{w})}^\top \mathbf{t} + {(\mathbf{X}\mathbf{w})}^\top  \mathbf{X}\mathbf{w} \\
    = \mathbf{t}^\top \mathbf{t} - 2 {\mathbf{w}}^\top  \mathbf{X}^\top \mathbf {t} + {\mathbf{w}}^\top  \mathbf{X}^\top \mathbf{X} \mathbf{w}
\end{eqnarray*}

\begin{eqnarray*}
{\partial\mathcal{L} \over \partial \mathbf{w}}= -2\mathbf{X}^\top \mathbf {t} + 2\mathbf{X}^\top \mathbf{X} \mathbf{w} = 0
\end{eqnarray*}

\begin{eqnarray*}
  2\mathbf{X}^\top \mathbf{X} \mathbf{w} = 2\mathbf{X}^\top \mathbf{t}
\end{eqnarray*}

\begin{eqnarray*}
     \mathbf{\hat{w}} = {(\mathbf{X}^\top \mathbf{X})}^{-1}  \mathbf{X}^\top \mathbf{t}
\end{eqnarray*}
This expression is the same as the one that is derived from the average (mean) loss.\\
